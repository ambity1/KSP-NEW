		...
		<div className={cl.content}>
			<div className={cl.contentBlock}>
				...
				<p className={cl.contentText}>
					Мы рады, что вы выбрали наш магазин и надеемся, что приобретенный товар оправдал ваши ожидания. Однако, иногда
					могут возникнуть ситуации, когда товар не подходит или оказался бракованным. Если такое произошло, мы
					предлагаем вам несколько вариантов решения этой проблемы:{' '}
				</p>
				<br />
				<div className={cl.pNumber}>
					...
					<p className={cl.contentText}>
						Обратиться к нам с просьбой о замене товара. Мы гарантируем качество наших товаров и готовы заменить их на
						другие, если они соответствуют вашим требованиям. Для этого вам нужно обратиться к нашему менеджеру по
						телефону или электронной почте и предоставить описание проблемы.
					</p>
					<p className={cl.contentText}>
						Связаться с нашей службой поддержки клиентов. Мы готовы помочь вам решить любые проблемы, связанные с
						покупкой товара. Наши специалисты ответят на все ваши вопросы и помогут выбрать оптимальный вариант решения
						проблемы.
					</p>
				</div>
			</div>
			<div className={cl.contentBlock}>
				...
				<br />
				<p className={cl.contentText}>
					Если товар был приобретен по акции или со скидкой, то возврат возможен только в случае обнаружения брака. В
					этом случае необходимо предоставить фото дефекта или видеозапись с ним.
				</p>
				<br />
				<p className={cl.contentText}>
					Для возврата товара необходимо заполнить заявление на возврат, которое можно найти на нашем сайте. К заявлению
					нужно приложить копию паспорта и квитанции об оплате заказа.
				</p>
				<br />
				<p className={cl.contentText}>
