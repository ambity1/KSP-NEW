	...
	return (
		<div className={cl.content}>
			...
			<div className={cl.contentBlock}>
				...
				<p className={cl.contentText}>
					Для заказа доставки необходимо указать адрес доставки и количество товаров. Длительность доставки зависит от
					курьерской службы. Стоимость доставки зависит от веса и размера заказа.
				</p>
			</div>
		</div>
	)
